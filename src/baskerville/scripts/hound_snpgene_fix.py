...
from baskerville.snps import score_gene_snps_target
...
def main():
    ...
    if options.processes is not None:
        score_gene_snps_target(params_file, model_file, vcf_file, worker_index, options)
    else:
        score_gene_snps_target(params_file, model_file, vcf_file, 0, options)
