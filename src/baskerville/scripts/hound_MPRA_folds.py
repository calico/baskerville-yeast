...
def main():
    ...
    for ci in range(options.crosses):
        for fi in fold_index:
            ...
            cmd_fold = '%s time python /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/baskerville-yeast/src/baskerville/scripts/hound_MPRA.py %s %s' % (cmd_base, params_file, model_file)
