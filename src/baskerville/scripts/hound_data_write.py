...
def main():
    ...
    print("Targets: %d" % num_targets, file=sys.stderr)
    print("seqs_cov_files: ", seqs_cov_files, file=sys.stderr)
    ...
    for ti in range(num_targets):
        ...
        seqs_cov_open.close()
    print("targets.shape: ", targets.shape, file=sys.stderr)
    ...
    with tf.io.TFRecordWriter(tfr_file, tf_opts) as writer:
        for si in range(num_seqs):
            ...
            print("msi: ", msi) 
            print("mseq: ", mseq)            
            print("mseq_start: ", mseq_start)
            print("mseq_end: ", mseq_end)   
