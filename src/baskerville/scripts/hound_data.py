...
# $BASKERVILLEDIR/scripts/hound_data.py \
# --local \
# -l 16384 \
# -w 64 \
# -c 1024 \
...
# -r 256 \
# --stride 6165 \
# -b $YEASTSEQDIR/R64_annotations/mask_rossi.bed \
# -u $YEASTSEQDIR/R64_annotations/mask_rossi.bed \
# --umap_clip 0.5 \
# -g $YEASTSEQDIR/R64_annotations/assembly_gaps.bed \
# -o data \
# $YEASTSEQDIR/R64_annotations/S288C_R64-3-1.fasta cleaned_sheet.txt \
# 1>data.out 2>data.err
